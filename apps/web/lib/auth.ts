 ...
 *
 * Default fallback is ``/app`` — the V1 authenticated homepage with
 * the chat composer. (Pre-v1, this was ``/drawings``; the older
 * drawings index is still reachable via the upload flow, but the
 * default landing is the kitchen-centric homepage.)
 */
