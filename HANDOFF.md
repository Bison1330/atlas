...
| M8  | Projects + teams     | planned  | Drawings → project, per-project membership. Depends on M7. |
| M8.1| Invitations + RBAC   | planned  | admin/member/viewer roles scoped to a project. Depends on M8. |
